...
#define ROW_COUNT 100 //Change me as needed
...
int main()
{
	...
	printf("Multiplication with pthreads, size: %d, took %f seconds.\n",ROW_COUNT * COLUMN_COUNT, (stop-start)/(double)CLOCKS_PER_SEC); //Print time
